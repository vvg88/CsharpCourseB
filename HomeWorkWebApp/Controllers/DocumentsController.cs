...
namespace HomeWorkWebApp.Controllers
{
    ...
    {
        private DocumentsDb db = new DocumentsDb();
        ...
        public ActionResult Create([Bind(Include = "Id,Text")] Document document)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Text")] Document document)
        {
            if (ModelState.IsValid)
            {
